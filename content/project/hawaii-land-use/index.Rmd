---
title: Spatial analysis of land-use cover and watersheds in Hawaii
author: Alex Milward
date: '2020-03-08'
slug: '.'
categories: []
...
summary: ''
authors: []
lastmod: '2020-03-08T14:03:41-07:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
land_use <- read_sf(dsn = here("content", "project", "hawaii-land-use", "Land_Use_Land_Cover_LULC"), layer = "Land_Use_Land_Cover_LULC") 
...
```{r}
# Read in data
watersheds <- read_sf(dsn = here("content", "project", "hawaii-land-use", "Watersheds"), layer = "Watersheds") %>% 
  select(wuname)
